...
const repOdbc_migracion = async (req, res) => {
	...
	---Migracion
	select id_informante,cec.id_pregunta,
	(case when cec.id_pregunta in (95) then 'PREGUNTA 35.¿Dónde nació? ¿en qué municipio?' 
	...
	(case when cec.id_pregunta in (97,103,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cec.respuesta else null end) pais, 
	(case when cec.id_pregunta in (97,103,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cec.codigocodif else null end) codigo_pais_codif, 
	(case when cec.id_pregunta in (97,103,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cc.descripcion else null end) acep_desc_pais_codif, 
	(case when cec.id_pregunta in (97,103,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cec.codigocodif_v1 else null end) codigo_pais_super, 
	(case when cec.id_pregunta in (97,103,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cc2.descripcion else null end) acep_desc_pais_super,
	(case when cec.id_pregunta in (97,103,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cec.codigocodif_v2 else null end) codigo_pais_jefe, 
	(case when cec.id_pregunta in (97,103,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cc3.descripcion else null end) acep_desc_pais_jefe,
	'' as cod_rev_pais,
	
	(case when cec.id_pregunta in (95,103,105) or (cec.id_pregunta=129 and (cec.respuesta_apoyo='3' or cec.respuesta_apoyo isnull or cec.respuesta_apoyo='')) then cec.usucodificador else null end) usuario_mun_codif, 
	(case when cec.id_pregunta in (95,103,105) or (cec.id_pregunta=129 and (cec.respuesta_apoyo='3' or cec.respuesta_apoyo isnull or cec.respuesta_apoyo='')) then cec.usuverificador else null end) usuario_mun_super, 
	(case when cec.id_pregunta in (97,101,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cec.usucodificador else null end) usuario_pais_codif, 
	(case when cec.id_pregunta in (97,101,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cec.usuverificador else null end) usuario_pais_super,
	
	(case when cec.id_pregunta in (95,103,105,97,101,107,129) then cec.feccodificador else null end)::text fecha_codif
	...
	where not codigocodif isnull and codigocodif<>'' and cec.id_pregunta in (55,95,97,101,103,105,107,129) 
	AND feccodificador::date BETWEEN '${req.params.fechaInicial}'::date AND '${req.params.fechaFinal}'::date
	order by id_pregunta, id_informante	
	`;
...
const repOdbc = async (req, res) => {
	...
	max(case when ep.id_pregunta in (113) then concat(ep.respuesta->(respuesta3::INTEGER-1)->'respuesta') else null end) Nivel,
	max(case when ep.id_pregunta in (114) then concat(ep.respuesta->(respuesta3::INTEGER-1)->'respuesta') else null end) curso_anio,
	max(case when ep.id_pregunta in (126) then concat(ep.respuesta->(respuesta3::INTEGER-1)->'respuesta') else null end) Categoria,
	max(case when ep.id_pregunta in (122) then concat(ep.respuesta->(respuesta3::INTEGER-1)->'respuesta') else null end) Destino_agropecuario,
	...
	max(cec.feccodificador) fecha_codif
	from codificacion.cod_encuesta_codificacion cec
...
const reporte6 = async (req, res) => {
	const query = {
		text: `
		select departamento||'-'||cc.descripcion depto,(case when departamento||'-'||cc.descripcion isnull then 'TOTAL GENERAL' when not departamento||'-'||cc.descripcion isnull and cv.pregunta isnull then 'TOTAL '||(departamento||'-'||cc.descripcion) else departamento||'-'||cc.descripcion end) departamento,
