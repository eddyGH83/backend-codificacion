...
const repOdbc_migracion = async (req, res) => {
	...
	(case when cec.id_pregunta in (95,103,105) or (cec.id_pregunta=129 and (cec.respuesta_apoyo='3' or cec.respuesta_apoyo isnull or cec.respuesta_apoyo='')) then cec.usuverificador2 else null end) usuario_mun_jefe, 
	...
	(case when cec.id_pregunta in (97,101,107) or (cec.id_pregunta=129 and cec.respuesta_apoyo='4') then cec.usuverificador2 else null end) usuario_pais_jefe,
	
	(case when cec.id_pregunta in (95,103,105,97,101,107,129) then date(cec.feccodificador) else null end)::text fecha_codif
